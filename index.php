...
<html lang="pt-BR">
    ...
    <body id="begin">
        <span itemscope itemtype="http://schema.org/Product">
            <nav id="menu-principal" class="navbar-default navbar-fixed">
                <div class="nav-wrapper">
                    <a href="#inicio" class="brand-logo logo"><span itemprop="name">Romano Dev</span></a>
            ...
            <section id="who">
                ...
                <div class="container box">
                    <div class="row">
                        ...
                        <div itemprop="review" itemscope itemtype="http://schema.org/Review" class="col s12 m4 l8">
            ...
            <section itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating" id="customers">
                <div id="clientes"></div>
                <h2 itemprop="ratingValue" class="center fontwhite">Clientes</h2>
        ...
        <script src="prod/js/jquery.bxslider.min.js"></script>
        <script src="prod/js/scripts.min.js"></script>
        <script src="prod/js/materialize.min.js"></script>
